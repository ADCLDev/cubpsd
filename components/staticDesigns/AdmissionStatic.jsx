    ...
    <div className="basis-3/5 relative">
                        <div className="bg-rose-100 p-10 flex flex-col gap-5 sticky top-16 xl:top-20 rounded-3xl">
                            ...
                            <div className="h-44 flex flex-col justify-center gap-3 pl-7 xl:w-96 rounded-3xl bg-red-600">
                                <p className="text-white font-bold text-xl">Course Fee</p>
                                <p className="text-white font-bold text-2xl">BDT 12,000</p>
                                <div>
                                    <Link href="https://docs.google.com/forms/d/e/1FAIpQLSfKrradQ3wN8U38QjHopuHbPP9596CGZZiP-dFNAOweETs-YA/viewform?usp=sf_link">
                                        <button className="bg-white text-red-700 p-2 w-48 rounded-xl">Enroll Now</button>
                                    </Link>
                                </div>
                            </div>                            
                        </div>
...
export default AdmissionStatic
