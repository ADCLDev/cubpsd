        ...
        <div>
            <div className="flex flex-col lg:flex-row items-center py-10 gap-5 mx-2 lg:mx-auto lg:max-w-4xl xl:max-w-7xl">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <h1 className="font-bold text-5xl">Professional <span className="font-extrabold text-5xl text-red-500">Skill Training</span> for Industry Success</h1>
                    ...
                    <div className="flex gap-5">
                        <Link href='/category/all'><div><button className="btn btn-xl w-[200px] text-xl bg-wine-700 hover:bg-wine-500 text-white"><span className="text-xl hidden md:flex"><IoLibrary /></span>Courses </button></div></Link>
