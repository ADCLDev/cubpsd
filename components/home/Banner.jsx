        ...
        <div>
            <div className="flex flex-col lg:flex-row items-center py-10 gap-5 mx-2 lg:mx-auto lg:max-w-4xl xl:max-w-7xl">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="flex gap-3 text-lg font-bold"><span><Image src="/courses_image/reward.png" alt="" width={25} height={25} /></span>Unlock Your Brilliance</p>
                    <h1 className="font-bold text-5xl">Conquer the Tech World <br></br>Become an  <span className="font-extrabold text-5xl text-red-500">IT Expert</span></h1>
